...
- **Phase 11 — idea upvotes** (D73) + **idea comments/discussion** (11.2, D74), from a mock user-panel exercise. Panel backlog still queued: **idea date/location**; weighted picker declined.

Test suite green at last local run: typecheck (7) + lint (6) + format; unit (validation 77 / api-client 168 / core 32); **pgTAP 188**; **Playwright 59**; live probes run_picker 9/9, send-push 9/9, delete-account 10/10.

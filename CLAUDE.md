...
- **Phase 11** — from a mock user-panel exercise: **idea upvotes** (11.1, D73), **idea comments/discussion** (11.2, D74), **idea date + location** (11.3, D75). Panel backlog now cleared; weighted picker declined.

Test suite green at last local run: typecheck (6) + lint (6) + format; unit (validation 80 / api-client 170 / core 32); **pgTAP 191**; **Playwright 59**; live probes run_picker 9/9, send-push 9/9, delete-account 10/10.

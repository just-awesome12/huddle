 ...
 *
 * Flow:
 *   1. Build a deep-link callback URL: powwow://auth-callback
 ...
 *
 * The deep link `powwow://auth-callback` requires the app's scheme to be
 * registered. In app.json the scheme is set to "powwow".
 *
